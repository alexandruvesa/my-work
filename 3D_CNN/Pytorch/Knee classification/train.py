# -*- coding: utf-8 -*-
"""
Created on Wed Dec  2 23:48:59 2020
...
def run(args):
    ...
    train_dataset = MRDataset("E:/Alex Work/Datasets/MRNet-v1.0/", args.task,
    ...
    validation_dataset = MRDataset(
        "E:/Alex Work/Datasets/MRNet-v1.0/", args.task, args.plane, train=False)
    ...
    for epoch in range(num_epochs):
        ...
        if val_auc > best_val_auc:
            ...
            if bool(args.save_model):
                ...
                for f in os.listdir('E:/Alex Work/my-work/3D_CNN/Pytorch/Knee classification/models/'):
                    if (args.task in f) and (args.plane in f) and (args.prefix_name in f):
                        os.remove(f'E:/Alex Work/my-work/3D_CNN/Pytorch/Knee classification/models/models/{f}')
                torch.save(mrnet, f'E:/Alex Work/my-work/3D_CNN/Pytorch/Knee classification/models/models/{file_name}')
