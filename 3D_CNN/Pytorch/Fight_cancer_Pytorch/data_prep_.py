# -*- coding: utf-8 -*-
"""
Created on Sun Dec 20 22:04:50 2020
...
def getCandidateInfoList(requireOnDisk_bool=True):
    ...
    # the subsets yet.
    mhd_list = glob.glob('E:/Alex Work/Datasets/Luna Dataset/subset*/*.mhd')
...
class Ct:
    def __init__(self, series_uid):
        mhd_path = glob.glob(
            'E:/Alex Work/Datasets/Luna Dataset/subset*/*.mhd'.format(series_uid)
        )[0]
