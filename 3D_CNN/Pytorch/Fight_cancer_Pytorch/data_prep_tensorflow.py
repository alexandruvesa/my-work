# -*- coding: utf-8 -*-
"""
Created on Sun Dec 20 22:10:54 2020
...
class LunaDataset(Sequence):
    ...
    def __getitem__(self, ndx):
        ...
        print(candidate_a)
        candidate_t = candidate_a
        tf.dtypes.cast(candidate_t, tf.float32)
        #candidate_t =candidate_t.unsqueeze(0)
        candidate_t = tf.expand_dims(candidate_t,axis=0)
        
        pos_t = [
            not candidate_info_tup.isNodule_bool,
            candidate_info_tup.isNodule_bool]
        
        return (candidate_t, pos_t, candidate_info_tup.series_uid,(center_irc))
