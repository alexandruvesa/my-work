# -*- coding: utf-8 -*-
"""
Created on Sun Dec  6 01:36:28 2020
...
class LunaModel(nn.Module):
    def __init__(self, in_channels=1, conv_channels=8):
        ...
        self.block2 = LunaBlock(in_channels*2, conv_channels*4)
        self.block2 = LunaBlock(in_channels*4, conv_channels*8)
        ...
        for m in self.modules():
            if type(m) in {
                ...
                nn.init.kaiming_normal_(
                    m.weight.data, a=0, mode = 'fan_out',
                    nonlinearity='relu',)
