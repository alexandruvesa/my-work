...
pathOrig  = r'C:\Users\alexandru.vesa\Desktop\Research\New_Personal_Program_DL_Programming\GitMy\my-work\FinanciaApplication\cabinetDrPascalau\pascalauFill.xlsx'
...
def procenteVenit():
    w1=np.arange(0.03, 0.094, 0.001)
    #w1 = np.array([0.094])
    w2=np.arange(0.04,0.07, 0.003)
